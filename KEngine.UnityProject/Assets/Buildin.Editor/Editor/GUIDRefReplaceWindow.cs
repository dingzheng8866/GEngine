...
public class GUIDRefReplaceWindow : EditorWindow
{
    ...
    [MenuItem("Window/GUIDRefReplaceWindow ")]   // 菜单开启并点击的   处理
    public static void GUIDRefReplaceWin()
    {

        // true 表示不能停靠的
        _window = (GUIDRefReplaceWindow)EditorWindow.GetWindow(typeof(GUIDRefReplaceWindow), true, "GUID替换 (●'◡'●)");
    ...
    HGUILayout.TabGroupData<TabType> tabGroupData
    {
        get
        {
            if (_tabGroupData == null)
            {
				...
				_tabGroupData.AddTab("GUID", TabType.GUID);
				_tabGroupData.AddTab("Builtin Material", TabType.Material);
				_tabGroupData.AddTab("Builtin Sprite", TabType.Sprite);
				_tabGroupData.AddTab("Builtin Texture", TabType.Texture);
				_tabGroupData.AddTab("Builtin Shader", TabType.Shader);
            }
	...
	string material_Sprites_Default_oldUid_e				= "{fileID: 10754, guid: 0000000000000000e000000000000000, type: 0}";
	string material_Default_Skybox_oldUid_e					= "{fileID: 10304, guid: 0000000000000000e000000000000000, type: 0}";
	string material_Default_Particle_oldUid_e				= "{fileID: 10301, guid: 0000000000000000e000000000000000, type: 0}";
	string material_Default_Material_oldUid_e				= "{fileID: 10303, guid: 0000000000000000e000000000000000, type: 0}";
	string material_Default_Diffuse_oldUid_e				= "{fileID: 10302, guid: 0000000000000000e000000000000000, type: 0}";
	...
	void GUI_MaterialList()
	{
		...
		GUILayout.Space(60);
		GUILayout.Label("0000000000000000e000000000000000");
		GUILayout.Space(20);
		GUI_ObjItem<Material>("Sprites-Default", material_Sprites_Default, material_Sprites_Default_oldUid_e, MATERIAL_GUID_NEW);
		GUILayout.Space(20);
		GUI_ObjItem<Material>("Default-Skybox", material_Default_Skybox, material_Default_Skybox_oldUid_e, MATERIAL_GUID_NEW);
		GUILayout.Space(20);
		GUI_ObjItem<Material>("Default-Particle", material_Default_Particle, material_Default_Particle_oldUid_e, MATERIAL_GUID_NEW);
		GUILayout.Space(20);
		GUI_ObjItem<Material>("Default-Material", material_Default_Material, material_Default_Material_oldUid_e, MATERIAL_GUID_NEW);
		GUILayout.Space(20);
		GUI_ObjItem<Material>("Default-Diffuse", material_Default_Diffuse, material_Default_Diffuse_oldUid_e, MATERIAL_GUID_NEW);
	}
	#endregion
    ...
    string sprite_Background_oldUid_e                         = "{fileID: 10907, guid: 0000000000000000e000000000000000, type: 0}";
    string sprite_Checkmask_oldUid_e                          = "{fileID: 10901, guid: 0000000000000000e000000000000000, type: 0}";
    string sprite_DropdownArrow_oldUid_e                      = "{fileID: 10915, guid: 0000000000000000e000000000000000, type: 0}";
    string sprite_InputFieldBackground_oldUid_e               = "{fileID: 10911, guid: 0000000000000000e000000000000000, type: 0}";
    string sprite_Knob_oldUid_e                               = "{fileID: 10913, guid: 0000000000000000e000000000000000, type: 0}";
    string sprite_UIMask_oldUid_e                             = "{fileID: 10917, guid: 0000000000000000e000000000000000, type: 0}";
    string sprite_UISprite_oldUid_e                           = "{fileID: 10905, guid: 0000000000000000e000000000000000, type: 0}";
	...
	void GUI_SpriteList()
	{
        ...
        GUI_ObjItem<Sprite>("Background", sprite_Background, sprite_Background_oldUid_e, SPRITE_GUID_NEW);
        GUILayout.Space(20);
        GUI_ObjItem<Sprite>("Checkmask", sprite_Checkmask, sprite_Checkmask_oldUid_e, SPRITE_GUID_NEW);
        GUILayout.Space(20);
        GUI_ObjItem<Sprite>("DropdownArrow", sprite_DropdownArrow, sprite_DropdownArrow_oldUid_e, SPRITE_GUID_NEW);
        GUILayout.Space(20);
        GUI_ObjItem<Sprite>("InputFieldBackground", sprite_InputFieldBackground, sprite_InputFieldBackground_oldUid_e, SPRITE_GUID_NEW);
        GUILayout.Space(20);
        GUI_ObjItem<Sprite>("Knob", sprite_Knob, sprite_Knob_oldUid_e, SPRITE_GUID_NEW);
        GUILayout.Space(20);
        GUI_ObjItem<Sprite>("UIMask", sprite_UIMask, sprite_UIMask_oldUid_e, SPRITE_GUID_NEW);
        GUILayout.Space(20);
        GUI_ObjItem<Sprite>("UISprite", sprite_UISprite, sprite_UISprite_oldUid_e, SPRITE_GUID_NEW);
	}
	#endregion
